# Moduł 3: Sztuka promptowania

## Sekcja 1: Czym jest prompt?

Wyjaśnij uczestnikowi:

- Prompt to po prostu wiadomość, którą wysyłasz do Claude
...
Pokaż uczestnikowi kontrast:

**Słaby prompt:**
> "Napisz mi coś o kampanii"

**Dobry prompt:**
> "Jestem specjalistą ds. marketingu w firmie kurierskiej. Potrzebuję propozycji kampanii świątecznej skierowanej do e-commerce (MŚP). Budżet: 50 000 PLN. Kanały: social media + e-mail. Napisz krótki brief z: celem kampanii, grupą docelową, kluczowym przekazem i harmonogramem."

Wyjaśnij różnicę:
- Słaby prompt = brak kontekstu, Claude zgaduje
...
Wyjaśnij uczestnikowi prostą technikę:

- **R — Rola:** Kim ma być Claude? ("Jesteś strategiem marketingowym...")
- **K — Kontekst:** Jaka jest sytuacja? ("Firma kurierska, rynek polski, segment e-commerce...")
- **K — Komenda:** Co dokładnie ma zrobić? ("Napisz brief kampanii świątecznej...")
- **F — Format:** Jak ma wyglądać odpowiedź? ("W formie tabeli / listy / 3 propozycji...")

Analogia: "RKKF to jak struktura briefu marketingowego — background, objective, deliverable, format. Taki sam schemat, inna nazwa."

Daj przykład:
> **R:** Jesteś copywriterem specjalizującym się w branży e-commerce.
> **K:** Piszę newsletter dla klientów B2B firmy kurierskiej. Wysyłamy 10 000 paczek dziennie.
...
- Możesz doprecyzowywać: "Zmień ton na bardziej formalny", "Skróć do 3 zdań", "Dodaj CTA"
