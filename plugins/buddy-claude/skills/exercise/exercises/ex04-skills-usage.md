# Ćwiczenie 4: Korzystanie ze skilli

**Poziom:** Średni
**Czas:** 10 minut
**Cel:** Nauczyć się świadomie korzystać ze skilli Buddy-Claude i rozumieć jak działają.
...
### Krok 2: Test /hint
Powiedz uczestnikowi:
"Teraz udajmy że utknąłeś/aś. Wpisz `/hint` i zobacz co się stanie. Buddy powinien zapytać z czym potrzebujesz pomocy. Wybierz jedną z opcji lub opisz problem własnymi słowami."

Poczekaj i zapytaj: "Czy podpowiedź była pomocna? Hint nie daje gotowej odpowiedzi — naprowadza. To celowe."
...
4. Wróć do normalnej rozmowy

Spróbuj: zacznij pisać z Claude krótki brief i w trakcie użyj /explain lub /hint."
...
4. W przyszłości pojawią się nowe skille dopasowane do Twojej pracy

Gotowy/a na finałowe wyzwanie? Wpisz `/exercise 5`."
