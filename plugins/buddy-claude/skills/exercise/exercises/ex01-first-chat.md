# Ćwiczenie 1: Pierwsza rozmowa

**Poziom:** Podstawowy
**Czas:** 5-10 minut
**Cel:** Przełamać pierwsze lody z Claude — napisać prompt i zobaczyć odpowiedź.

## Instrukcja dla Buddy-Claude

Prowadź uczestnika przez te kroki. Po każdym kroku poczekaj aż uczestnik go wykona.
...
Powiedz uczestnikowi:
"Teraz zadaj Claude proste pytanie związane z Twoją pracą. Na przykład:
- 'Jakie są trendy w e-commerce w Polsce w 2026?'
...
Powiedz uczestnikowi:
"Teraz poproś Claude o zmianę w tej samej rozmowie. Na przykład:
- 'Skróć to do 3 punktów'
- 'Napisz to prostszym językiem'
- 'Dodaj konkretne przykłady z branży kurierskiej'"

Poczekaj i zapytaj: "Widzisz jak Claude pamięta kontekst rozmowy i reaguje na feedback?"
...
Gotowy/a na więcej? Wpisz `/exercise 2` żeby nauczyć się technik promptowania."
